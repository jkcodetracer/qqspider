...
class InitMessages(object):
    ...
    def __init__(self):
        ...
        self.thread_num_QQ = 1  # 同时下载几个QQ的日志，每个QQ的抓取使用不同的cookie登录
